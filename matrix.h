...
void matrix_add(matrix_t* RESTRICT const c, const matrix_t* RESTRICT const a, const matrix_t* RESTRICT const b) HOT;
/*!
...
/*!
* \brief Performs a matrix addition such that {\ref c} = {\ref a} + {\ref b}
* \param[in] a Matrix A
* \param[in] b Matrix b
